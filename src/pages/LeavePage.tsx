  ...
  return (
    <div>
      <PageHeader
        ...
        <Button
          variant="primary"
          onClick={() => setLeaveStatus(pendingIds, 'Approved')}>
      ...
      <Card className="overflow-hidden">
        ...
        <EmptyState
          icon={PlaneIcon}
          title="Nothing here"
          description={`No ${tab.toLowerCase()} leave requests.`} /> :
            ...
            return (
              <li
                ...
                className="flex flex-col gap-3 px-5 py-4 sm:flex-row sm:items-center">
                  ...
                  <div className="flex flex-1 items-center gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-content-muted">
                        {getDepartment(emp.departmentId)?.name} · Requested{' '}
                        {formatDate(l.requestedOn)}
                      </p>
                  ...
                  <Badge tone={leaveStatusTone[l.status]} dot>
                        {l.status}
                      </Badge>
                  }
                  </div>
